...
Using if–elif–else conditions to:

Check if a number is Weird / Not Weird based on given rules
...
Printing squares of numbers using for loops

Printing a sequence 123...n without using string methods

Writing a function:

Implementing an is_leap(year) function to check leap years
...
Computing cumulative sums of a list of numbers.

Shuffle the Array

Rearranging an array from [x1,...,xn,y1,...,yn] to [x1,y1,x2,y2,...,xn,yn].

Kids With the Greatest Number of Candies

Checking, for each kid, if giving them all extra candies makes them have the greatest number among all.
...
Understanding the difference between integer and float division.

Using loops to generate sequences and patterns.

Creating functions to encapsulate logic (like leap year checks).

Solving beginner-friendly algorithm problems using arrays and loops.
...
More problem-solving notebooks

Data analysis and visualization tasks

Machine learning and Gen AI-related notebooks as the internship progresses
